...
const ReportIssue = () => {
    ...
    return (
            <View className={"h-screen bg-white"}>
                <TouchableOpacity onPress={() => router.push("/(screens)/Dashboard")} className={"flex-row gap-2 w-24 h-10 ml-5 items-center justify-center p-2 rounded-full bg-zinc-100"}>
